...
% addpath(genpath('/Users/berkin/Dropbox (Partners HealthCare)/RESEARCH/pulseq/MPRAGE/pulseq-develop_1.4.0/matlab'))
addpath(genpath('/autofs/cluster/kawin/berkin/Matlab_Code_New/pulseq/pulseq-develop_1.4.0/matlab'))
